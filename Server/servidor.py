...
while True:
    ...
    #PARAMETROEVALUACION
        ...
        listaAsiento = []
        sueldo13 = rn.calcular13(sql_query[1])
        sueldo14 = rn.calcular14(sql_query[1])
        gastoFondoReserva = rn.calcularGastoFondoReserva(sql_query[1])
        gastoAportePatronal = rn.calcularAportePatronal(sql_query[1])
        aportePersonalPagar = rn.aportePersonalPagar(sql_query[1])
        aportePatronalPagar = rn.aportePatronalPagar(sql_query[1])
        nominaPagar = rn.nominaPagar(sql_query[1])
